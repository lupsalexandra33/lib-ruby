/* ruby/config.h.  Generated by configure for Ruby 4.0.6 on x86_64-linux.
 * Modified by hand for compatibility with Unikraft and musl; entries marked
 * 'UNIKRAFT' are purposely different from the autoconfigured values.
 * When updating, regenerate with the host configure (see Makefile.uk) and
 * check every new HAVE_* entry against what musl and Unikraft provide:
 * declared is not enough, the symbol must also be defined at link time.
 */
#ifndef INCLUDE_RUBY_CONFIG_H
#define INCLUDE_RUBY_CONFIG_H 1

/* UNIKRAFT: CONFIG_* symbols used below */
#include <uk/config.h>
...
/* UNIKRAFT: compiler headers are not on the -nostdinc include path */
...
/* UNIKRAFT: musl 1.2.3 has no statx() */
...
/* UNIKRAFT: __libc_stack_end is glibc-only */
...
/* UNIKRAFT: no process spawning */
/* #define HAVE_FORK 1 */
/* #define HAVE_VFORK 1 */
/* #define HAVE_WORKING_VFORK 1 */
/* #define HAVE_WORKING_FORK 1 */
#define HAVE__LONGJMP 1
/* UNIKRAFT: musl 1.2.3 has no arc4random_buf() */
/* #define HAVE_ARC4RANDOM_BUF 1 */
#define HAVE_ATAN2L 1
#define HAVE_ATAN2F 1
/* UNIKRAFT: atomic_signal_fence is glibc-only */
...
#define HAVE_DIRFD 1
/* UNIKRAFT: declared, but not defined at link time */
...
/* UNIKRAFT: M:N threads are selected automatically whenever <sys/epoll.h>
 * is available (thread_pthread.c). Keep the plain 1:1 pthread model.
 */
...
/* UNIKRAFT: musl has no <sys/user.h> */
...
#define USE_ELF 1
#define HAVE_ELF_H 1
/* UNIKRAFT: only with lib-zlib */
#if CONFIG_LIBZLIB
#define HAVE_LIBZ 1
#endif
#define EXTSTATIC 1
/* UNIKRAFT: no execinfo backtrace() */
/* #define HAVE_BACKTRACE 1 */
/* UNIKRAFT: no valgrind */
